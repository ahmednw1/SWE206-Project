...
public class Match implements Serializable {
    ...
    public Match(int matchNumber, Team team1, Team team2) {
    ...
    public Match(int matchNumber, Team team1, Team team2, LocalDate date) {
        this.matchNumber = matchNumber;
        this.team1 = team1;
        this.team2 = team2;
        this.date = date;
    ...
    public Team getWinner() {
        if (team1score > team2score) {
            ...
            // System.out.println(" match class --------"+matchNumber);
            Team team = new Team("Winner " + matchNumber);
            return team;
        }
    }
    ...
    public String toString() {
        return ("Matche " + matchNumber + " : ( " + team1.getName() + " vs " + team2.getName()+" )");
    }
